...
public class WriteShot {
	...
	/*
	 * Initialize the variables with the passed input_video_file_name,
	 * input_audio_file_name frame_start, frame_end
	 * 
	...
	public static void write_shot() {
		...
		try {
			...
			/*
			 * Read the input video file And skip the part till we find start of
			 * current_shot
			 */
